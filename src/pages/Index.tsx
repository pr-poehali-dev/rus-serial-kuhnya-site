  ...
  const quotes = [
    {
      ...
      text: "Кухня - это поле боя, а повар - это воин!",
      role: "Шеф-повар",
    },
    {
      character: "Виктор Батурин",
      text: "Все деньги мира не стоят одной минуты настоящего счастья",
      role: "Владелец ресторана",
    },
    {
      character: "Настя Заворотнюк",
      text: "Любовь приходит и уходит, а вкусная еда остается навсегда",
      role: "Официантка",
    },
    {
      character: "Дмитрий Нагиев",
      text: "Готовить - это как любить: либо с головой, либо вообще не стоит браться",
      role: "Су-шеф",
    },
  ];
